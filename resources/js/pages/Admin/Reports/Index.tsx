                ...
                {groups.length === 0 ? (
                    ...
                    <div className="flex flex-col gap-8">
                        {groups.map((group) => (
                            ...
                            >
                                <h2 className="text-muted-foreground dark:text-primary text-[11px] font-semibold tracking-[0.28em] uppercase">
                                    {group.name}
                                </h2>
                                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                                    {group.reports.map((report) => (
                                        <Link
                                            key={report.title}
                                            href={report.href}
                                            className="group border-border/70 bg-card hover:border-primary/30 flex flex-col gap-2 rounded-2xl border p-4 shadow-xs transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm dark:shadow-none"
                                        >
