...
// Mirrors the store rule vocabulary (BranchController::store) — the only
// values the server will accept. The branch image is managed from the
// Index row action (and is optional on the server), so this form covers
...
export default function Create() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setProcessing(true);
        router.post(BranchRoutes.store().url, data as never, {
            onError: (err) => {
...
Create.layout = {
    breadcrumbs: [
        ...
        { title: 'Create', href: BranchRoutes.create().url },
    ],
};
