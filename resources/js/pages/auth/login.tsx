                        ...
                        <div className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    {canResetPassword && (
                                        <TextLink
                                            href={request()}
                                            className="text-[11px] text-[#070E01]/30 transition-colors hover:text-[#2D5016]"
                                            tabIndex={5}
                                        >
                                            Forgot?
                                        </TextLink>
                            ...
                            <div className="flex items-center gap-3 pt-1">
                                <Checkbox
                                    ...
                                    name="remember"
                                    tabIndex={3}
                                    className="border-[#070E01]/15 data-[state=checked]:border-[#2D5016] data-[state=checked]:bg-[#2D5016]"
                                />
                                <Label
                                    htmlFor="remember"
                                    className="cursor-pointer text-[13px] text-[#070E01]/40"
                                >
                                    Remember me
                                </Label>
                            </div>
