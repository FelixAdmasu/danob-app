...
import { Github, LayoutGrid, Menu, Search } from 'lucide-react';
                        ...
                        <Sheet>
                            ...
                            >
                                ...
                                <SheetHeader className="flex justify-start text-left">
                                    <div className="flex h-6 w-6 items-center justify-center rounded bg-neutral-900 text-white dark:bg-white dark:text-neutral-900">
                                        <AppLogoIcon className="h-4 w-4 fill-current text-white dark:text-neutral-900" />
                                    </div>
